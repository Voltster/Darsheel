...
const About = () => {
  ...
  const cardsData = [
    {
      icon: "💼",
      title: "Co-founder at PatilKaki",
      description: "Passionate about food, people, and brand building.",
    },
    {
      icon: "🚀",
      title: "Visionary Leader",
      description:
        "Dedicated to helping fellow founders navigate the challenges of D2C.",
    },
    {
      icon: "🌟",
      title: "Achievements",
      description: "Recipient of numerous awards for culinary excellence.",
    },
  ];
      ...
      <div className=" relative   flex items-center  n justify-center overflow-hidden z-50 ">
          ...
          <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
              ...
              <div className="lg:max-w-xl lg:pr-5 relative z-40">
                <p className="flex uppercase text-xl  ">About Us</p>
                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                  We make you look
                  <span className="my-1 inline-block border-b-8 border-g4 bg-yellow-500 px-4 font-bold text-g4 animate__animated animate__flash">
                    different
                  </span>
                </h2>
                <p className="text-base text-gray-800">
                Darsheel Savla is a co-founder at PatilKaki, driven by a passion for food, people, and brand building. With an unyielding commitment to culinary exploration, he aims to share the legendary recipes of PatilKaki with the world
                </p>
                <div className="mt-10 flex flex-col items-center md:flex-row">
                  <a
                    href="/"
                    className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-yellow-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-yellow-600 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                  >
                    View More
                  </a>
                  <a
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="my-6 mx-auto h-10 w-10 animate-bounce rounded-full bg-yellow-500 p-2 lg:hidden"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="2"
              ...
              <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <img src="https://img.freepik.com/free-photo/pensive-concentrated-managers-standing-modern-cafe_1262-17088.jpg?size=626&ext=jpg&ga=GA1.1.1766789214.1686656956&semt=ais" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" absolute -bottom-24 left-10 z-0  opacity-10 ">
          <svg
            ...
            height="800px"
            viewBox="0 0 24 24"
            className="w-96 z-0  h-full    object-fill fill-yellow-800 text-yellow-500"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
        ...
        <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
          <svg
            ...
            viewBox="0 0 256 256"
            xmlns="http://www.w3.org/2000/svg"
            className="w-48 z-0  h-full -rotate-90   object-fill fill-yellow-800 text-yellow-500"
          >
            <path
